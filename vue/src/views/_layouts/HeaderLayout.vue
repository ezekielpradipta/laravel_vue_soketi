<template>
  <nav
    class="relative z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700"
  >
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button
            @click="buttonShowSidebar"
        ...
        <div class="flex items-center">
          ...
          <div class="flex items-center ml-3">
            <UserDropDownLayout></UserDropDownLayout>
          </div>
        </div>
      </div>
    </div>
...
import DarkModeLayout from './DarkModeLayout.vue'
